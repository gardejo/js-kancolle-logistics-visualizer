 ...
 */
kclv.Projector.Materials.Simple = function(offset) {
    /**
...
kclv.Projector.Materials.Simple.prototype.project = function(tuple) {
    return kclv.Array.values(tuple, this.attributes);
};
...
kclv.Projector.Materials.High = function() {
    kclv.Projector.Materials.Simple.call(this, 1);
...
kclv.Projector.Materials.Low = function() {
    kclv.Projector.Materials.Simple.call(this, 0);
