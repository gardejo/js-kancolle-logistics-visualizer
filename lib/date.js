...
/**
 * Get an object representing the period of its own date by the specified
 *     frequency.
 * @public
 * @param {string} frequency A string representing the frequency.
 * @returns {Object.<string, (Date|string)>} An object representing the period
 *     of its own date.
...
/**
 * Get a new date object representing the next period by the specified
 *     frequency.
 * @public
 * @param {string} frequency A string representing the frequency.
 * @returns {Date} A new date object representing the next period.
 * @throws {kclv.Exception.InvalidFrequency} If the specified frequency is
 *     invalid.
 * @nosideeffects
 */
kclv.Date.prototype.toNextPeriod = function(frequency) {
    var date = this.toPeriod(frequency).v,
        property,
        offset = 1;
    ...
    return new Date( date['set' + property](
        date['get' + property]() + offset
    ) );
};
...
kclv.Date.prototype.getDayOfYear_ = function() {
    return Math.floor(
        ( this.date_ - this.toNewYearsDay() ) / 86400000 // 60*60*24*1000
    );
};
...
kclv.Date.prototype.getDayOfNewYearsDay_ = function(opt_year) {
    return this.toNewYearsDay(opt_year).getDay();
};
 ...
 * @nosideeffects
 */
kclv.Date.prototype.toNewYearsDay = function(opt_year) {
 ...
 * @nosideeffects
 */
kclv.Date.prototype.toFirstDayOfMonth = function() {
 ...
 * @nosideeffects
 */
kclv.Date.prototype.toMonday = function() {
    return new Date( this.toMidnight().setDate(
        this.date_.getDate() - (
            this.date_.getDay() ?
 ...
 * @nosideeffects
 */
kclv.Date.prototype.toMidnight = function() {
    return new Date(
