...
// ----------------------------------------------------------------
// Exception for an Invalid Ships Order
// ----------------------------------------------------------------

/**
 * An exception for an invalid ships order.
 * @public
 * @constructor
 * @extends {kclv.Exception.InvalidKind}
 * @param {!string} kind A string representing an invalid rank of ships.
 */
kclv.Exception.InvalidShipsOrder = function(kind) {
    kclv.Exception.InvalidKind.call(
        this,
        'kclv.Exception.InvalidShipsOrder',
        ['Arrival', 'Experiences'],
        kind
    );
...
kclv.Exception.InvalidShipsOrder.prototype =
    Object.create(kclv.Exception.InvalidKind.prototype);
kclv.Exception.InvalidShipsOrder.prototype.constructor =
    kclv.Exception.InvalidKind;
