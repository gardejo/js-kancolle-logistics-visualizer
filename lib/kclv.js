...
kclv.Table.Ships.Base.prototype.buildRows = function() {
    ...
    if (this.option === 'Experiences') {
        relation.sort( function(a, b) {
            return a[4] === b[4] ? // Exp. 1,000,000 is Lv. 99 or 100.
                b[3] - a[3] : // Compare levels (100 > 99) descendingly.
                b[4] - a[4];  // Compare experience pionts descendingly.
        } );
    }
    ...
    if (this.table.opposite) {
        option.vertical.opposingBaseline =
            kclv.Configuration.get(
                ['chart', this.table.opposite, 'vertical', 'minimum']
            );
    }
