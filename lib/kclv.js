...
kclv.Agent.SandanshikiKanpan.prototype.buildRelation = function(relationName) {
    var concreteRelationNames,
        contents = {};

    switch (relationName) {
        case 'Materials':
            concreteRelationNames = [
    ...
    concreteRelationNames.forEach( function(
        concreteRelationName, indexOfColumn, concreteRelationNames
    ) {
        ...
        this.getLog_(relationName, concreteRelationName).forEach( function(
            ...
            contents[date][indexOfColumn] = tuple[1];
        }, this );
    }, this );
    ...
    return kclv.Factory.getInstance(kclv.Relation, relationName).
        insert(
            ...
            Object.keys(contents).sort().map( function(date, index, dates) {
...
kclv.Tokenizer.SandanshikiKanpan.Materials.prototype.toColumns = function(
    ...
    var columns =
            kclv.Tokenizer.SandanshikiKanpan.Base.prototype.toColumns.apply(
                this, arguments
            ),
...
kclv.Table.Materials.Candlestick.prototype.buildRows = function() {
    ...
    table.push( this.relation.reduce( function(row, tuple, index, relation) {
        var current = new kclv.Date(tuple[0]).toPeriod(frequency),
