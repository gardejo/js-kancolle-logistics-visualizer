...
kclv.Chart.Base.prototype.setThreshold = function(
    ...
    option[direction].maximum =
        this.getThreshold(configuration, direction, 'maximum', opt_kind);
    option[direction].minimum =
        this.getThreshold(configuration, direction, 'minimum', opt_kind);
