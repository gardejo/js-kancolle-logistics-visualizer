...
kclv.Table.Ships.Bubble.prototype.buildColumns = function() {
    ...
    return [
        { label: legend.classification, type: 'string' },
        { label: legend.total,          type: 'number' },
        { label: legend.average,        type: 'number' },
        { label: legend.rate,           type: 'number' },
        { label: legend.practical,      type: 'number' }
    ];
};
...
kclv.Table.Ships.Bubble.prototype.buildRows = function() {
    ...
    return Object.keys(roster).map( function(shipClass) {
        ...
        return [
            ...
            Math.round( practicalNumber * 100 / totalNumber ) / 100,
            practicalNumber
        ];
    } );
};
