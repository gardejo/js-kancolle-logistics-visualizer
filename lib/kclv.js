...
kclv.Table.Materials.Candlestick.prototype.buildRows = function() {
    var attribute = this.relation.getIndexOf(this.kind),
...
kclv.Table.Ships.Base.prototype.buildRows = function() {
    ...
    var indexOf = this.getClassificationDictionary_(),
        ...
        attributeOf = {
            ID             : this.relation.getIndexOf('ID'),
            Name           : this.relation.getIndexOf('Name'),
            Classification : this.relation.getIndexOf('Classification'),
            Levels         : this.relation.getIndexOf('Levels'),
            Experiences    : this.relation.getIndexOf('Experiences')
        },
        ignoreMothball =
            kclv.Configuration.get('chart.Ships.ignoreMothball', true);
    ...
    return relation.map( function(tuple, index) {
        ...
        if (ignoreMothball && tuple[ attributeOf.Levels ] === mothballLevel) {
            return { c : columns };
        }
