...
kclv.Game.Materials = ( function() {
    ...
    */
    ...
    /**
     * An alignment which compares material kinds with concrete material names.
    ...
    /**
     * A list of concrete materials as a flattened array.
     *     Note: It is in particular order (order sensitive).
     * @private {Array.<string>}
     * @const
     */
    var MATERIALS = [].concat(
        MATERIALS_OF.Resources, MATERIALS_OF.Consumables
    );

    return {
        /**
         * Get an alignment which compares material kinds with concrete
         *     material names.
         * @public
         * @returns {Object.<string, Array.<string>>} An alignment which
         *     compares material kinds with concrete material names.
         * @nosideeffects
         */
         ...
         * @throws {kclv.Exception.InvalidMaterial} If the specified concrete
        ...
        getKindOf : function(material) {
            ...
            throw new kclv.Exception.InvalidMaterial(material, MATERIALS);
        },
