 ...
 * @nosideeffects
 */
kclv.Table.Materials.Candlestick.prototype.ensureDirectiveValidated = function(
) {
    kclv.Table.Base.prototype.ensureDirectiveValidated.call(
        this,
        kclv.Game.Materials.MATERIALS,
...
kclv.Table.Materials.Candlestick.prototype.buildRows = function() {
    ...
    table.push( this.relation.reduce( function(row, tuple) {
        ...
        if ( row && row[0].f === current.f ) { // Staying the same period.
            ...
            if (row) { // Not the first row. (row !== null)
        ...
        return row;
    }, null ) ); // The last row was placed at the end.
 ...
 * @nosideeffects
 */
kclv.Table.Materials.Line.prototype.ensureDirectiveValidated = function() {
    kclv.Table.Base.prototype.ensureDirectiveValidated.call(
        this,
        Object.keys(kclv.Game.Materials.MATERIALS_OF).
            concat(kclv.Game.Materials.MATERIALS),
        [null]
    );
...
kclv.Table.Materials.Line.prototype.buildRows = function() {
    ...
    return this.relation.clone().
        ...
        map( function(tuple) {
            tuple[indexOfDateTime] = {
                v : tuple[indexOfDateTime].toJSON(),
                f : tuple[indexOfDateTime].toLocaleString()
            };
            return tuple;
        } );
};
