 ...
 * @nosideeffects
 */
kclv.Table.Base.prototype.ensureDirectiveValidated = function(
...
/**
 * Get the opening time stamp or the number of the first row of the table.
 * @public
 * @const
 * @returns {number|Date} The opening time stamp of the table represented by
 *     a time series, or the number of the first row of the simple table.
 * @nosideeffects
 * @see #closing
 */
...
/**
 * Get the closing time stamp or the number of the last row of the table.
 * @public
 * @const
 * @returns {number|Date} The closing time stamp of the table represented by
 *     a time series, or the number of the last row of the simple table.
 * @nosideeffects
 * @see #opening
 */
...
/**
 * Check whether the table is represented by a time series.
 * @public
 * @const
 * @returns {boolean} Whether the table is represented by a time series.
 * @nosideeffects
 */
kclv.Table.Base.prototype.isChronological = function() {
    return this.relation.isChronological();
};
