 ...
 * @throws {kclv.Exception.InvalidRelation} If the specified relation kind is
 *     invalid.
 */
kclv.Tokenizer.Base = function(kind, hasHeader, commentSign) {
    ...
    // Mix in an object which is involved with a relation kind.
    var mixedInObject = kclv.Tokenizer[this.kind_];
    if (! mixedInObject) {
        throw new kclv.Exception.InvalidRelation(this.kind_);
    }
    mixedInObject.call(this);
...
// ----------------------------------------------------------------
// Namespace for Tokeninzers of LogbookEx
// ----------------------------------------------------------------

/**
 * A namespace for tokenizers of LogbookEx.
 * @public
 */
kclv.Tokenizer.LogbookEx = {};

// ----------------------------------------------------------------
// Tokeninzer for a LogbookEx's Materials Log
// ----------------------------------------------------------------

/**
 * A tokenizer for a LogbookEx's materials log.
 * @public
 * @constructor
 * @extends {kclv.Tokenizer.Logbook.Base}
 */
kclv.Tokenizer.LogbookEx.Materials = function() {
    kclv.Tokenizer.Logbook.Materials.call(this);
...
kclv.Tokenizer.LogbookEx.Materials.prototype =
    Object.create(kclv.Tokenizer.Logbook.Materials.prototype);
kclv.Tokenizer.LogbookEx.Materials.prototype.constructor =
    kclv.Tokenizer.Logbook.Materials;

// ----------------------------------------------------------------
// Tokeninzer for a LogbookEx's Ships Log
// ----------------------------------------------------------------

/**
 * A tokenizer for a LogbookEx's ships log.
 * @public
 * @constructor
 * @extends {kclv.Tokenizer.LogbookEx.Base}
 */
kclv.Tokenizer.LogbookEx.Ships = function() {
    kclv.Tokenizer.Logbook.Ships.call(this);
     ...
     *     ...    : (snip)
     *    22 -> 3 : Level.
     *    23      : Experience points to next level.
     *    24 -> 4 : Experience points.
     *     ...    : (snip)
     *     </pre>
     * @override
     * @protected {Object.<string, number>}
...
kclv.Tokenizer.LogbookEx.Ships.prototype =
    Object.create(kclv.Tokenizer.Logbook.Ships.prototype);
kclv.Tokenizer.LogbookEx.Ships.prototype.constructor =
    kclv.Tokenizer.Logbook.Ships;
