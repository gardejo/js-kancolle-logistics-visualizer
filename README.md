...
This file describes *KanColle Logistics Visualizer version 0.2.0 (Beta)* in brief.
...
この文書は *KanColle Logistics Visualizer（艦これ 兵站図示儀） 第0.2.0版（ベータ版）* について簡単に記したものです。
