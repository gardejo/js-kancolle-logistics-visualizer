...
This file describes *KanColle Logistics Visualizer version 0.1.0 (Alpha)* in brief.
...
この文書は *KanColle Logistics Visualizer（艦これ 兵站図示儀） 第0.1.0版（アルファ版）* について簡単に記したものです。
